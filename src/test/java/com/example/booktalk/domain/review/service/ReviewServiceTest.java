...
class ReviewServiceTest {
    ...
    class Review_수정_테스트 {
        ...
        void Review_수정_시_Review가_존재하지_않으면_에러를_반환() {
            ...
            //when & then
            assertThrows(NotFoundReviewException.class, () -> reviewService.updateReview(nonExistingReviewId, req, 1L));
        }
        ...
        void Review_수정_시_본인의_review가_아니면_에러를_반환() {
            ...
            //when & then
            assertThrows(NotPermissionReviewAuthorityException.class, () -> reviewService.updateReview(1L, req, 2L));
