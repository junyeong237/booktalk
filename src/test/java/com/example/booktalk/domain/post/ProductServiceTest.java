...
//                productService.createProduct(TEST_USER_ID, req);
//            });
//
//            // then
...
//                    TEST_ANOTHER_USER);
//
////                given(userRepository.findById(eq(TEST_ANOTHER_USER_ID))).willReturn(
////                    Optional.of(TEST_ANOTHER_USER)); //-> 이거 nullPointException
//
//                // when
//                GlobalException exception = assertThrows(GlobalException.class, () -> {
